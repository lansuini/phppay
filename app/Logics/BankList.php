...
class BankList {
     ...
     * @return
     */
    public static function bandCardInfo($card)
    {
        $card_8 = substr($card, 0, 8);
        if (isset(self::$banks[$card_8])) {
            return self::$banks[$card_8];
        }
        $card_6 = substr($card, 0, 6);
        if (isset(self::$banks[$card_6])) {
            return self::$banks[$card_6];
        }
        $card_5 = substr($card, 0, 5);
        if (isset(self::$banks[$card_5])) {
            return self::$banks[$card_5];
        }
        $card_4 = substr($card, 0, 4);
        if (isset(self::$banks[$card_4])) {
            return self::$banks[$card_4];
        }
        return false;
    }
     ...
     * @link http://www.yinhangkahao.com/bank_luhm.html
    ...
    private static function getBankCardCheckCode(string $nonCheckCodeCardId) {
        ...
        if ($nonCheckCodeCardId == null
            || strlen(trim($nonCheckCodeCardId)) == 0
