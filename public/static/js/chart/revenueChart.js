$(function() {
    $("#btnSearch").initSearch(apiPath + "revenueChart", getColumns(), {
        success_callback: buildSummary
    });
    $("#btnExport").bind('click',function () {
        $("#btnExport").initExport(apiPath + "revenueChart", getColumns(), {})
    });
